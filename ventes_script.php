...
/**
 *      \file       beerresaler/ventes_script.php
 *		\ingroup    beerresaler
...
// Examples for manipulating class ventes_class
require_once(DOL_DOCUMENT_ROOT."/../beerresaler/ventes.class.php");
$myobject=new Ventes($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."ventes";
