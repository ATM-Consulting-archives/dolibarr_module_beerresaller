...
/**
 *      \file       beerresaler/beers_script.php
 *		\ingroup    beerresaler
...
// Examples for manipulating class beers_class
require_once(DOL_DOCUMENT_ROOT."/../beerresaler/beers.class.php");
$myobject=new Beers($db);
